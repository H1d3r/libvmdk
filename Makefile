...
pkgdatadir = $(datadir)/libvmdk
pkgincludedir = $(includedir)/libvmdk
pkglibdir = $(libdir)/libvmdk
pkglibexecdir = $(libexecdir)/libvmdk
...
am__aclocal_m4_deps = $(top_srcdir)/m4/common.m4 \
	...
	$(top_srcdir)/m4/types.m4 $(top_srcdir)/m4/yaltools.m4 \
...
CONFIG_CLEAN_FILES = include/libvmdk/definitions.h \
	include/libvmdk/features.h include/libvmdk/types.h \
	dpkg/changelog libvmdk.pc libvmdk.spec pyproject.toml
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/libvmdk.pc.in \
	$(srcdir)/libvmdk.spec.in $(srcdir)/pyproject.toml.in \
	$(top_srcdir)/dpkg/changelog.in \
	$(top_srcdir)/include/libvmdk/definitions.h.in \
	$(top_srcdir)/include/libvmdk/features.h.in \
	$(top_srcdir)/include/libvmdk/types.h.in ABOUT-NLS AUTHORS \
...
ACLOCAL = ${SHELL} '/Users/joker/Downloads/libvmdk-20260714/missing' aclocal-1.18
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} '/Users/joker/Downloads/libvmdk-20260714/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/joker/Downloads/libvmdk-20260714/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/joker/Downloads/libvmdk-20260714/missing' automake-1.18
AWK = awk
CC = gcc
...
DEPDIR = .deps
DLLTOOL = false
DPKG_DATE = Wed, 29 Jul 2026 11:06:17 +0800
DSYMUTIL = dsymutil
DUMPBIN = 
ECHO_C = \c
ECHO_N = 
...
LIBFUSE_CPPFLAGS = -I/usr/local/include/fuse3 -D_FILE_OFFSET_BITS=64
LIBFUSE_LIBADD = -L/usr/local/lib -lfuse3 -lpthread
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/Users/joker/Downloads/libvmdk-20260714/missing' makeinfo
MAN = /usr/bin/man
...
OTOOL64 = :
PACKAGE = libvmdk
PACKAGE_BUGREPORT = https://github.com/libyal/libvmdk/issues
PACKAGE_NAME = libvmdk
PACKAGE_STRING = libvmdk 20260714
PACKAGE_TARNAME = libvmdk
PACKAGE_URL = 
PACKAGE_VERSION = 20260714
PATH_SEPARATOR = :
...
SET_MAKE = 
SHELL = /bin/sh
SPEC_DATE = Wed Jul 29 2026
STATIC_LDFLAGS = 
STRIP = strip
TESTS_MANPAGE_LINTER = mandoc
TESTS_USE_MINGW = no
TESTS_USE_WINAPI = no
USE_NLS = no
VERSION = 20260714
...
ZLIB_CPPFLAGS = 
ZLIB_LIBADD = -lz
abs_builddir = /Users/joker/Downloads/libvmdk-20260714
abs_srcdir = /Users/joker/Downloads/libvmdk-20260714
abs_top_builddir = /Users/joker/Downloads/libvmdk-20260714
abs_top_srcdir = /Users/joker/Downloads/libvmdk-20260714
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
fuse3_CFLAGS = -I/usr/local/include/fuse3
fuse3_LIBS = -L/usr/local/lib -lfuse3 -lpthread
fuse_CFLAGS = 
fuse_LIBS = 
...
install_sh = ${SHELL} /Users/joker/Downloads/libvmdk-20260714/install-sh
libbfio_CFLAGS = 
libbfio_LIBS = 
libcdata_CFLAGS = 
libcdata_LIBS = 
...
libuna_CFLAGS = 
libuna_LIBS = 
libvmdk_spec_requires = Requires:
libvmdk_spec_tools_build_requires = BuildRequires:
...
DPKG_FILES = \
	...
	dpkg/copyright \
	dpkg/rules \
	dpkg/libvmdk.install \
	dpkg/libvmdk-dev.install \
	dpkg/libvmdk-python3.install \
	dpkg/libvmdk-tools.install \
	dpkg/source/format
...
$(am__aclocal_m4_deps):
include/libvmdk/definitions.h: $(top_builddir)/config.status $(top_srcdir)/include/libvmdk/definitions.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
include/libvmdk/features.h: $(top_builddir)/config.status $(top_srcdir)/include/libvmdk/features.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
include/libvmdk/types.h: $(top_builddir)/config.status $(top_srcdir)/include/libvmdk/types.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
dpkg/changelog: $(top_builddir)/config.status $(top_srcdir)/dpkg/changelog.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libvmdk.pc: $(top_builddir)/config.status $(srcdir)/libvmdk.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libvmdk.spec: $(top_builddir)/config.status $(srcdir)/libvmdk.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
